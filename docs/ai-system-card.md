...
| Approved retrieval | Azure AI Search queries only the indexed, approved fictional policy corpus. |
...
- Local keyword retrieval and the deployed Azure AI Search implementation share
